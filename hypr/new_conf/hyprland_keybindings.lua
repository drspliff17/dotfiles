...
hl.bind(mainMod .. " + v", hl.dsp.window.float(), { submap_universal = true })
hl.bind(mainMod .. " + SHIFT + v", hl.dsp.window.pin(), { submap_universal = true })
...
for i = 1, 10 do
	...
	hl.bind(
		...
		hl.dsp.exec_cmd("/home/drspliff/.config/hypr/scripts/move_all_to_workspace.sh" .. key)
	)
end
...
--TODO: Reimplement grim binds, but executing a bash script instead of large bind

hl.bind(mainMod .. " + F1", hl.dsp.exec_cmd("timeout 30 $HOME/.config/hypr/scripts/dmenu_music_selector.sh artist"))
hl.bind(
	mainMod .. " + SHIFT + F1",
	hl.dsp.exec_cmd("timeout 30 $HOME/.config/hypr/scripts/dmenu_music_selector.sh files")
)
hl.bind(
	mainMod .. " + CTRL + F1",
	hl.dsp.exec_cmd("timeout 30 $HOME/.config/hypr/scripts/dmenu_music_selector.sh update")
)

hl.bind(mainMod .. " + F2", hl.dsp.exec_cmd("timeout 120 $HOME/.config/hypr/scripts/dmenu_doc_selector.sh"))
...
-- Notification Mode
hl.bind(mainMod .. " + d", hl.dsp.submap("Notification"))
